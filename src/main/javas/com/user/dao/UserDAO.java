...
public class UserDAO {
	...
	private String jdbcURL="jdbc:mysql://localhost:3306/MeditationPlatform";
	...
	public void insertUser(User user) 
	{
		...
		{
			java.sql.PreparedStatement preparedStatement=connection.prepareStatement(INSERT_USER_SQL);
	...
	public boolean deleteUser(int id) 
	{
		...
		try(Connection connection=dao.getConnection())
		{
			...
			java.sql.PreparedStatement preparedStatement=connection.prepareStatement(DELETE_USERS_SQL);
			preparedStatement.setInt(1, id);
